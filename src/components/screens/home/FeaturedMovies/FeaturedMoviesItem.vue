<template>
    <section class="section-featured ">
        ...
        <div v-if="items.length" class="featured-movies-sliders">
            <InfiniteCaruselle class="infinite-caruselle">
                <ul>
                    <li v-for="movie in items.slice(0, 10)" :key="movie.id">
            ...
            <InfiniteCaruselle reverse class="infinite-caruselle">
                <ul>
                    <li v-for="movie in items.slice(10, 20)" :key="movie.id">
                        <CategoryPreviewItem :item="movie" image-only />
                    </li>
                </ul>
            </InfiniteCaruselle>
            <InfiniteCaruselle  class="infinite-caruselle">
                <ul>
                    <li v-for="movie in items.slice(20, 30)" :key="movie.id">
                        <CategoryPreviewItem :item="movie" image-only />
                    </li>
                </ul>
            </InfiniteCaruselle>
            <InfiniteCaruselle reverse class="infinite-caruselle">
                <ul>
                    <li v-for="movie in items.slice(30, 40)" :key="movie.id">
                        <CategoryPreviewItem :item="movie" image-only />
                    </li>
                </ul>
            </InfiniteCaruselle>
...
<script>
    ...
    import InfiniteCaruselle from '@/components/InfiniteCaruselle.vue'
    import {CategoryPreviewItem} from '@/components/CategoryPreview'

    export default {
        name: "FeaturedMoviesItem",
        components: {
            AppButton,
            InfiniteCaruselle,
            CategoryPreviewItem
