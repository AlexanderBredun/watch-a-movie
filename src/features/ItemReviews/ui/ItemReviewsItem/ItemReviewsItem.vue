<template>
    <div class="item-review" :class="review.type.toLowerCase()">
        ...
        <div class="review-content">
            ...
            <AppButton variant="slim" pallete="gray" class="btn-show-all" :class="{ 'hide-btn': opened }"
...
import { ref } from 'vue';
import type { ItemReview } from '@/shared/lib/types';
import { formatDate } from '@/shared/lib/utils';
import AppButton from '@/shared/ui/AppButton/AppButton.vue';

interface ItemReviewsItemProps {
    review: ItemReview
}

const props = defineProps<ItemReviewsItemProps>();
